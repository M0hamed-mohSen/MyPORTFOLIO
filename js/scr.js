...
document.getElementById("card2").addEventListener('click', () => {
    window.open('https://m0hamed-mohsen.github.io/PORTFOLIO/')
});
document.getElementById("card3").addEventListener('click', () => {
    window.open('https://m0hamed-mohsen.github.io/Movie-APP/')
});
...
var typed = new Typed(".type2", {
    strings: ["Mohamed", "Mohsen", "Front end"],
    typeSpeed: 100,
    backSpeed: 60,
    loop: true
});
